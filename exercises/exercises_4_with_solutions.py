...
from solutions import check_exercise_4, wells, sd150, sd7  # just ignore this it is for the exercises solution

# !!! To here.

# exercise 4.1
# In exercise 3.3 we did a stream depletion assement:
#        exercise 3.3
