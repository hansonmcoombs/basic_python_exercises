...
from solutions import check_exercise_2, sd7, sd150, wells  # just ignore this it is for the exercises solution
...
# check your answers
check_exercise_2(globals())  # don't worry about how this works for now
